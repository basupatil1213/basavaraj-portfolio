  ...
  return (
    <Container id="projects">
      <Wrapper>
        ...
        <Desc>
          I have worked on a wide range of projects. From web apps to blockchains. Here are some of my projects.
        </Desc>
        <ToggleButtonGroup >
          {toggle === 'all' ?
          ...
          <Divider />
          {toggle === 'web app' ?
            <ToggleButton active value="web app" onClick={() => setToggle('web app')}>MERN Stack Web Apps</ToggleButton>
            :
            <ToggleButton value="web app" onClick={() => setToggle('web app')}>MERN Stack Web Apps</ToggleButton>
          }
          <Divider />
          {toggle === 'blockchain' ?
